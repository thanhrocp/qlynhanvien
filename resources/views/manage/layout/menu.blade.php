  ...
  <div class="left_col scroll-view">
    ...
    <div class="profile clearfix">
      ...
      <div class="profile_pic">
        ...
        <img src="upload/avatar/{{isset($user)?$user->employees->avatar:null}}" alt="..." class="img-circle profile_img">
        ...
        <ul class="nav side-menu">
          ...
          <li><a><i class="fa fa-edit"></i> Phòng ban<span class="fa fa-chevron-down"></span></a>
            ...
            <ul class="nav child_menu">
              ...
              <li><a href="{{route('departList')}}">Danh sách</a></li>
              <li><a href="{{route('departAdd')}}">Thêm mới</a></li>
            </ul>
