    ...
    <div class="row">
      ...
      <div class="x_panel">
        ...
        <div class="x_title">
          ...
          <h2>Edit Department <small>(Sửa phòng / ban)</small></h2>
          ...
          <form class="form-horizontal form-label-left" method="POST">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <input type="text" value="{{isset($edit_depart)?$edit_depart->depart_name:null}}" placeholder="Ghi tên phòng" class="form-control" name="depart_name">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <input type="number" value="{{isset($edit_depart)?$edit_depart->depart_phone:null}}" placeholder="Nhập số điện thoại" name="depart_phone" class="form-control">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <textarea class="form-control" placeholder="Nhập ghi chú" name="depart_note">{{isset($edit_depart)?$edit_depart->depart_note:null}}</textarea>
